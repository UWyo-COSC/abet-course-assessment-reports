# ABET Assessment Results for AY 2019-20
...
history.excelled <- data.frame(
    a=c(62,  45,  61, NA, get.excelled('a')),
    b=c(69,  46,  34, 29, get.excelled('b')),
    c=c(71,  58,  31, 54, get.excelled('c')),
    d=c(66,  53,  12, 71, get.excelled('d')),
    e=c(20,  98,  92, 68, get.excelled('e')),
    f=c(83,  67,  22, 47, get.excelled('f')),
    g=c(20, 100,  NA, NA, get.excelled('g')),
    h=c(20,  81,  NA, NA, get.excelled('h')),
    i=c(67,  56,  70, NA, get.excelled('i')),
    j=c(79,  36,  34, 31, get.excelled('j')),
    k=c(49,  74,  NA, NA, get.excelled('k')))
history.mastered <- data.frame(
    a=c(10, 35,  10, NA, get.mastered('a')),
    b=c(14, 33,  39, 31, get.mastered('b')),
    c=c( 8, 22,  62, 46, get.mastered('c')),
    d=c(17, 24,  84, 29, get.mastered('d')),
    e=c(80,  2,   6, 18, get.mastered('e')),
    f=c( 6, 29,  54, 53, get.mastered('f')),
    g=c(80,  0,  NA, NA, get.mastered('g')),
    h=c(80, 10,  NA, NA, get.mastered('h')),
    i=c(24, 26,  23, NA, get.mastered('i')),
    j=c(15, 26,  17, 22, get.mastered('j')),
    k=c(15,  8,  NA, NA, get.mastered('k')))
history.partially.mastered <- data.frame(
    a=c(12,  9,  12, NA, get.partially.mastered('a')),
    b=c(10, 15,   7, 31, get.partially.mastered('b')),
    c=c(11,  9,   4,  0, get.partially.mastered('c')),
    d=c( 7, 19,   3,  0, get.partially.mastered('d')),
    e=c( 0,  0,   0, 12, get.partially.mastered('e')),
    f=c(11,  4,  21,  0, get.partially.mastered('f')),
    g=c( 0,  0,  NA, NA, get.partially.mastered('g')),
    h=c( 0,  9,  NA, NA, get.partially.mastered('h')),
    i=c( 3, 10,   2, NA, get.partially.mastered('i')),
    j=c( 2, 17,  31, 28, get.partially.mastered('j')),
    k=c(24,  2,  NA, NA, get.partially.mastered('k')))
history.below.expectations <- data.frame(
    a=c(16, 11,  18, NA, get.below.expectations('a')),
    b=c( 7,  6,  20,  9, get.below.expectations('b')),
    c=c(10, 11,   3,  0, get.below.expectations('c')),
    d=c(10,  4,   1,  1, get.below.expectations('d')),
    e=c( 0,  0,   2,  0, get.below.expectations('e')),
    f=c( 0,  0,   2,  0, get.below.expectations('f')),
    g=c( 0,  0,  NA, NA, get.below.expectations('g')),
    h=c( 0,  0,  NA, NA, get.below.expectations('h')),
    i=c( 6,  7,   5, NA, get.below.expectations('i')),
    j=c( 4, 21,  18, 19, get.below.expectations('j')),
    k=c(12, 16,  NA, NA, get.below.expectations('k')))
...
Outcome | %Satisfied 2014-15       | %Satisfied 2015-16       | %Satisfied 2016-17       | %Satisfied 2018-19       | %Satisfied 2019-20       | Last Year Change
:------:|-------------------------:|-------------------------:|-------------------------:|-------------------------:|-------------------------:|------------------------------------------------:
(1)     | `r history.pass[1, 'b']` | `r history.pass[2, 'b']` | `r history.pass[3, 'b']` | `r history.pass[4, 'b']` | `r history.pass[5, 'b']` | `r history.pass[5, 'b'] - history.pass[4, 'b']`
(2)     | `r history.pass[1, 'c']` | `r history.pass[2, 'c']` | `r history.pass[3, 'c']` | `r history.pass[4, 'c']` | `r history.pass[5, 'c']` | `r history.pass[5, 'c'] - history.pass[4, 'c']`
(3)     | `r history.pass[1, 'f']` | `r history.pass[2, 'f']` | `r history.pass[3, 'f']` | `r history.pass[4, 'f']` | `r history.pass[5, 'f']` | `r history.pass[5, 'f'] - history.pass[4, 'f']`
(4)     | `r history.pass[1, 'e']` | `r history.pass[2, 'e']` | `r history.pass[3, 'e']` | `r history.pass[4, 'e']` | `r history.pass[5, 'e']` | `r history.pass[5, 'e'] - history.pass[4, 'e']`
(5)     | `r history.pass[1, 'd']` | `r history.pass[2, 'd']` | `r history.pass[3, 'd']` | `r history.pass[4, 'd']` | `r history.pass[5, 'd']` | `r history.pass[5, 'd'] - history.pass[4, 'd']`
(6)     | `r history.pass[1, 'j']` | `r history.pass[2, 'j']` | `r history.pass[3, 'j']` | `r history.pass[4, 'j']` | `r history.pass[5, 'j']` | `r history.pass[5, 'j'] - history.pass[4, 'j']`
...
years <- c(2015, 2016, 2017, 2019, 2020)
year_labels = c('2014-15', '2015-16', '2016-17', '2018-19', '2019-20')
outcome_map=c('b', 'c', 'f', 'e', 'd', 'j')
for (idx in c(1, 2, 3, 4, 5, 6)) {
  # png(paste("outcome-", idx, ".png", sep=""))
  outcome = outcome_map[idx]
  hist <- c(history.pass[1, outcome], history.pass[2, outcome], history.pass[3, outcome], history.pass[4, outcome], history.pass[5, outcome])
